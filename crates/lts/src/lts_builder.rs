use mcrl3_utilities::{ByteCompressedVec, CompressedEntry};

use crate::{LabelIndex, StateIndex};
...
impl LtsBuilder {
    ...
    pub fn remove_duplicates(&mut self) { 
        ...
        indices.sort_unstable_by_key(|&i| (self.transition_from.index(i), self.transition_labels.index(i), self.transition_to.index(i)));
