...
- Miri confirmation: `cargo +nightly miri test -p merc_sharedmutex --lib recursive_lock` — **9/9 pass under Stacked Borrows**, including `test_read_recursive_during_with_mut_panics`. No UB anywhere in the fixed module.
